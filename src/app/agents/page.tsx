...
import IdentityHistory from "@/components/IdentityHistory";
    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Left: Register Form + Recent Registrations */}
          ...
          <div className="lg:col-span-2">
            {isCountLoading ? (
              ...
              <div className="bg-gray-900/50 rounded-2xl p-8 border border-gray-800 text-center">
                ...
                <p className="text-gray-400 text-lg">No agents registered on treasury yet</p>
                <p className="text-gray-500 text-sm mt-2">
                  Register an agent on ERC-8004 first, then add it to the treasury with a budget
                </p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
